package com.example.bot.spring.echo.repository.impl;
...
@Component
public class WarekiSeirekiMemRepository implements WarekiSeirekiRepository {
	...
	@Override
	public String findSeirekiText(String warekiGengo, int warekiYear) {
		return WAREKI_TO_SEIREKI_MAP.getOrDefault(warekiGengo + warekiYear, "");
	}

	@Override
	public String findWarekiText(int seirekiYear) {
		return SEIREKI_TO_WAREKI_MAP.getOrDefault(seirekiYear, "");
	}
